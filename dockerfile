...
# Download and extract Tomcat 10.1.35
RUN wget https://dlcdn.apache.org/tomcat/tomcat-10/v10.1.35/bin/apache-tomcat-10.1.35.tar.gz \
    && tar -xvf apache-tomcat-10.1.35.tar.gz \
    && rm apache-tomcat-10.1.35.tar.gz
...
</tomcat-users>' > /opt/apache-tomcat-10.1.35/conf/tomcat-users.xml
